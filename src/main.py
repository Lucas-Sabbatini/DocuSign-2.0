...
print("Bem vindo ao DocuSign 2.0, por favor digite um prompt para contrato ou documento")
prompt = input()
...
response = aiRequest.getContract(prompt=prompt,informationNeeded=itemsToSearch,storeRetrivals=vectorStoreResponses)
print(response)